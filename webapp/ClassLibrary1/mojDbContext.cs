...
namespace ClassLibrary1.Models
{
    public class mojDbContext : DbContext
    {
       ...
       => options.UseSqlServer(@"Server=app.fit.ba,1431;Database=p1903_seminarski_restoran;User ID=seminarski_baza_user;Password=marko_123?!.;MultipleActiveResultSets=True;");
